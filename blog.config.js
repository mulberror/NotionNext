...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Mulberror', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Mulberror的碎语', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://note.mulbx.top', // 网站地址
